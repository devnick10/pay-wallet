...
export const AddMoney = () => {
    ...
    const handleAddMoney = async () => {
        ...
        setIsLoading(true);
        try {
            const { success, onRampTxns, balance } = await createOnRampTransaction(amount, provider);
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Choose amount and bank to proceed with the transaction</CardDescription>
            </CardHeader>
