...
export const addStoreInfo = async (storeData: StoreData) => {
  ...
  if (storeData.description !== undefined) updatePayload.description = storeData.description;
  if (storeData.category !== undefined) updatePayload.category = storeData.category;
