              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    ...
                    solutions. No hardware needed, just your smartphone.
                  </p>
                </div>
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Generate dynamic QR codes for instant payments from
                    customers.
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Track sales, customer behavior, and business performance in
                    real-time.
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Industry-leading security protocols to protect your business
                    and customers.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col rounded-lg border bg-primary p-6 shadow-sm">
                <div className="space-y-2">
                  ...
                  <p className="text-primary-foreground/80">
                    For growing businesses with steady sales
                  </p>
                </div>
                <div className="mt-4 flex items-baseline">
          ...
          <div className=" px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Hear from businesses that have transformed with PayWallet
                  Business.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    &quot;PayWallet Business has revolutionized how we accept
                    payments. Our customers love the quick and easy process, and
                    we&apos;ve seen a 30% increase in sales.&quot;
                  </p>
                </div>
              ...
              <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    &quot;The analytics dashboard gives me insights I never had
                    before. I can now make data-driven decisions that have
                    improved my business operations significantly.&quot;
                  </p>
                </div>
                <div className="mt-6 flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10">
              ...
              <div className="flex flex-col justify-between rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-4">
                  <p className="text-muted-foreground">
                    &quot;Setting up was incredibly easy. The QR code system is
                    brilliant - no hardware costs, no maintenance, just scan and
                    pay. Perfect for my small business.&quot;
                  </p>
                </div>
                <div className="mt-6 flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/10">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join thousands of businesses that trust PayWallet for their
                  payment needs.
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
      ...
      <footer className="w-full border-t bg-background py-6 md:py-12">
        <div className="w-full flex justify-center items-center flex-col px-4 md:px-6">
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4 ">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                The simplest way to accept payments for your business. Fast,
          ...
          <div className="mt-8 border-t pt-8 text-center text-sm text-muted-foreground">
            © {new Date().getFullYear()} PayWallet Business. All rights
            reserved.
          </div>
        </div>
      </footer>
